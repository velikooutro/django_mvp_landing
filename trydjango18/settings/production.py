...
if not settings.DEBUG:
	...
	SECRET_KEY = 'qmhmd85y#6w!0k=%$!nwah@%k=z(x^6(&u2*2szg%%1@vld_%i'
	...
	EMAIL_HOST_USER = 'rmapuranga@gmail.com'
	EMAIL_HOST_PASSWORD = 'RaymondIsABoy**'
	EMAIL_PORT = 587
	EMAIL_USE_TLS = True 
	...
	STATIC_ROOT = '/home/velikooutro/webapps/mvpland_static/'
	...
	MEDIA_URL = '/media/'
	MEDIA_ROOT = '/home/velikooutro/webapps/mvpland_media/'
	# os.path.join(os.path.dirname(BASE_DIR), "static_in_env","media_root")

	# CRIPSY FORM TAGS SETTINGS
